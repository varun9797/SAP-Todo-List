...
describe('TodoController', () => {
  ...
  describe('getAllTodos', () => {
    it('should get all todos successfully', async () => {
      ...
      await TodoController.getAllTodos(req, res as Response<ApiResponse>);
    ...
    it('should handle errors when fetching todos', async () => {
      ...
      expect(mockedResponseUtil.internalServerError).toHaveBeenCalledWith(
        res,
        ERROR_MESSAGES.TODOS_FETCH_FAILED
      );
    });
  });
  ...
  describe('getTodoById', () => {
    ...
    it('should handle errors when fetching todo by id', async () => {
      ...
      expect(mockedResponseUtil.internalServerError).toHaveBeenCalledWith(
        res,
        ERROR_MESSAGES.TODO_FETCH_FAILED
      );
    });
  });
  ...
  describe('createTodo', () => {
    ...
    it('should handle errors when creating todo', async () => {
      ...
      expect(mockedResponseUtil.internalServerError).toHaveBeenCalledWith(
        res,
        ERROR_MESSAGES.TODO_CREATE_FAILED
      );
    });
  ...
  describe('updateTodo', () => {
    ...
    it('should update todo successfully', async () => {
      ...
      await TodoController.updateTodo(req as Request<{ id: string }>, res as Response<ApiResponse>);
  ...
  describe('deleteTodo', () => {
    ...
    it('should handle errors when deleting todo', async () => {
      ...
      expect(mockedResponseUtil.internalServerError).toHaveBeenCalledWith(
        res,
        ERROR_MESSAGES.TODO_DELETE_FAILED
      );
    });
  });
  ...
  describe('createSubTask', () => {
    ...
    it('should create subtask successfully', async () => {
      ...
      await TodoController.createSubTask(req as Request<{ todoId: string }>, res as Response<ApiResponse>);
  ...
  describe('updateSubTask', () => {
    ...
    it('should update subtask successfully', async () => {
      ...
      await TodoController.updateSubTask(req as Request<{ todoId: string; subtaskId: string }>, res as Response<ApiResponse>);
      ...
      expect(mockedResponseUtil.success).toHaveBeenCalledWith(
        ...
        SUCCESS_MESSAGES.SUBTASK_UPDATED
      );
    });
    ...
    it('should return 404 when todo or subtask not found', async () => {
      ...
      expect(mockedResponseUtil.notFound).toHaveBeenCalledWith(
        res,
        ERROR_MESSAGES.TODO_OR_SUBTASK_NOT_FOUND
      );
    });
  });
  ...
  describe('deleteSubTask', () => {
    ...
    it('should delete subtask successfully', async () => {
      ...
      expect(mockedResponseUtil.success).toHaveBeenCalledWith(
        res,
        undefined,
        SUCCESS_MESSAGES.SUBTASK_DELETED
      );
    });
    ...
    it('should return 404 when subtask not found', async () => {
      ...
      expect(mockedResponseUtil.notFound).toHaveBeenCalledWith(
        res,
        ERROR_MESSAGES.SUBTASK_NOT_FOUND
      );
    });
  });
});
